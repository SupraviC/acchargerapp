...
import com.supravin.accharger.OCPP_Implementation_1_6.OCPPWithOkHttpActivity;
...
public class InitiatingActivityOcpp extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseInstance.getReference(cid+"-STATUS").setValue("OCPP");
        mFirebaseInstance.getReference(cid+"-CP1M").setValue("ABSENT");
        mFirebaseInstance.getReference(cid+"-CP2M").setValue("ABSENT");
        mFirebaseInstance.getReference(cid+"-CP3M").setValue("ABSENT");*/

// Voltage
        /*mFirebaseInstance.getReference(cid+"-CP1-VoltageM").setValue("ABSENT");
        mFirebaseInstance.getReference(cid+"-CP2-VoltageM").setValue("ABSENT");
        mFirebaseInstance.getReference(cid+"-CP3-VoltageM").setValue("ABSENT");*/


//Current
      /*  mFirebaseInstance.getReference(cid+"-CP1-CurrentM").setValue("ABSENT");
        mFirebaseInstance.getReference(cid+"-CP2-CurrentM").setValue("ABSENT");
        mFirebaseInstance.getReference(cid+"-CP3-CurrentM").setValue("ABSENT");*/

 //Power
       /* mFirebaseInstance.getReference(cid+"-CP1-PowerM").setValue("ABSENT");
        mFirebaseInstance.getReference(cid+"-CP2-PowerM").setValue("ABSENT");
        mFirebaseInstance.getReference(cid+"-CP3-PowerM").setValue("ABSENT");*/

        //Amount
       /* mFirebaseInstance.getReference(cid+"-CP1-AmountM").setValue("ABSENT");
        mFirebaseInstance.getReference(cid+"-CP2-AmountM").setValue("ABSENT");
        mFirebaseInstance.getReference(cid+"-CP3-AmountM").setValue("ABSENT");*/
        //----Full Screen
        ...
        c4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(hname.matches("ssosoa")) {
                    Intent i = new Intent(InitiatingActivityOcpp.this, Authentication.class);
...
//        Toast.makeText(MainActivity.this," INTERNET off",Toast.LENGTH_SHORT).show();
    ...
    public void onResume() 
    {
        ...
        sPbatteryStatus = new SPbatteryStatus(InitiatingActivityOcpp.this);
  ...
  public void reRun(){
        if (sPbatteryStatus.getbatteryStatus().equals("Charging") || sPbatteryStatus.getbatteryStatus().equals("Full")){
            if (!txt_devices.getText().toString().equals("devices")) {
                ...
                //Intent i = new Intent(InitiatingActivityOcpp.this, MaindisplayActivityOcpp.class);
                //EDited By Pravin on 13-09-2019
                //Intent i = new Intent(InitiatingActivityOcpp.this, NewOCPPActivity.class);
                Intent i = new Intent(InitiatingActivityOcpp.this, OCPPWithOkHttpActivity.class);
                i.putExtra(EXTRA_DEVICE_ADDRESS, address);
                i.putExtra("SENDBOOT", "BOOT");
                startActivity(i);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if((getStatusString(status) == "Charging")){
               // Toast.makeText(context, "I Charging", Toast.LENGTH_SHORT).show();
                SPbatteryStatus sPbatteryStatus = new SPbatteryStatus(InitiatingActivityOcpp.this);
